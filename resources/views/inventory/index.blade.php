...
<x-app-layout>
    ...
    <table class="table table-hover table-striped">
        ...
        <tbody>
            ...
            <tr>
                <td><img src="{{ url($inventory->stall->img_path) }}" alt="stall image" width="50" height="50"></td>
                <td>{{ $inventory->stall->codename }}</td>
                <td>{{ $inventory->status }}</td>
                <td><a href="{{ url($inventory->leaseagreement) }}" target="_blank">View Agreement</a></td>
                <td>
